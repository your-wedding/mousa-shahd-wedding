      ...
      <section className="relative px-6 py-16">
        <div className="mx-auto max-w-md text-center">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a
              href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Mousa%20%26%20Shahd%20Wedding&dates=20260824T153000Z/20260824T200000Z&location=Wedding%20Venue&details=Wedding%20of%20Mousa%20%26%20Shahd"
              target="_blank"
              rel="noreferrer"
